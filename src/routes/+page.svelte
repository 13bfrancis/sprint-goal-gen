...
<div class="mx-auto max-w-sm pt-4">
	<h1
		class="text-center mb-8 text-3xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white"
	>
	...
	<form>
		...
		<p id="helper-text-explanation" class="mt-2 pl-1 text-sm text-gray-500 dark:text-gray-400">
			Describe what you want to achieve in this sprint.
		</p>
	</form>
</div>
